/*
    JITLang.js (Previously named VexScript)
...
(() => {
    ...
    class JITLangFunction {
        ...
        toString() {
            ...
            return `${funDec.name.lexeme}(${paramsStr.slice(0, paramsStr.length - 1)}) => ${funDec.returnType === "any" ? "" : funDec.returnType} {...}`;
        }
    }
    ...
    class Interpreter {
        ...
        stringify(obj) {
            if (obj.type === "null" || obj.type === "void") return obj.type;

            if (this.isNumberType(obj.type)) {
                let txt = obj.nat.toString();
                return txt.endsWith(".0") ? txt.slice(0, txt.length - 2) : txt;
            }

            if (this.isStringType(obj.type)) {
                return obj.nat;
            }
        ...
        evaluate(expr) {
            ...
            switch (expr.ExprType) {
                ...
                case "variable":
                    // console.log("IDK", this.environment);
        ...
        visitCallExpr(expr) {
            ...
            let fxn = callee;
            // console.log("CALLIN", fxn)
            if (fxn && fxn.type === "Function") {
                ...
                // console.log("RETURNED", fxn.nat.call(this, args))
                return fxn.nat.call(this, args);
            } else {
